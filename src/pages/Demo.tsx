          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative rounded-2xl overflow-hidden border border-border/50 bg-background/50 backdrop-blur">
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-muted/30">
                ...
                <span className="text-xs font-mono text-muted-foreground">Task Processor Mapping</span>
                <div className="flex items-center gap-2">
                  <button
              ...
              <iframe
                ...
                title="Task Processor Mapping Algorithm Demo"
                allow="fullscreen"
              />
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { title: 'Control', desc: 'Use play/pause and step controls to walk through the algorithm' },
                { title: 'Observe', desc: 'Watch starred, primed, and covered line states evolve' },
              ].map((item) => (
